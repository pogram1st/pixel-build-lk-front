<template>
    <div
        ...
        role="alert"
    >
        <div class="w-8 h-8 rounded-full flex items-center justify-center" :class="[primaryBgClasses[variant]]">
            <component :is="icons[variant]" :class="[textClasses[variant]]" class="w-[14px] h-[14px]" />
        </div>

        <div :class="[primaryTextClasses[variant], !description && 'pt-1 xl:pt-[4px]']" class="grid gap-1">
