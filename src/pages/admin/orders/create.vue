<template>
    <div class="max-w-4xl mx-auto space-y-6">
        <div class="flex items-center justify-between">
            ...
            <AppButton variant="outline" :to="RoutePaths[RouteNames.ADMIN_ORDERS] as string">
                Назад к списку
            </AppButton>
        </div>
        ...
        >
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <p v-if="errors.statusId" class="mt-1 text-sm text-red-600">
                        {{ errors.statusId }}
                    </p>
                </div>
            </div>
            ...
            <!-- Кнопки -->
            <div
                class="flex justify-end space-x-4 pt-4 border-t border-gray-200 dark:border-gray-700"
            >
                <AppButton
                    type="button"
                    variant="outline"
