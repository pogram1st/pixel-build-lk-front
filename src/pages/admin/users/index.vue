...
const createUser = async () => {
  try {
    ...
    toast.showError(error, 'Ошибка создания пользователя')
  }
}
...
const updateUser = async () => {
  try {
    ...
    toast.showError(error, 'Ошибка обновления пользователя')
  }
}
...
const deleteUser = async (id: number) => {
  ...
  try {
    ...
    toast.showError(error, 'Ошибка удаления пользователя')
  }
}
</script>
