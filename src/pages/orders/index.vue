<template>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Мои заказы</h1>
            <AppButton @click="showCreateModal = true"> Создать заказ </AppButton>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
            <div class="p-6">
                ...
                <AppTable v-else-if="orders" :columns="columns" :data="orders">
        ...
        <AppModal v-model="showCreateModal" title="Создать заказ">
            ...
            <template #footer>
                ...
                <AppButton @click="createOrder"> Создать </AppButton>
            </template>
        </AppModal>
    </div>
</template>
